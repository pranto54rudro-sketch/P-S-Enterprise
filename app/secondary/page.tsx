...
export default function SecondaryBusiness() {
  ...
  const peopleReturn = buying.reduce((a, x) => a + (x.people_funded ? monthlyReturn(x.people_funded, x.rate) / 30 * inclusiveDays(x.start_date, x.end_date || today()) : 0), 0);
